...
def train(model, tokenizer, dataset, num_epochs=20, batch_size=8, early_stopping_patience=3, learning_rate=5e-5, model_save_dir="models"):
    ...
    # Prepara tudo para o Accelerate lidar com as distribuições
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # Apenas o processo principal salva o modelo
...
def main():
    ...
    # Define path to file
    file_path = "/home/vberta/projects/def-aloise/vberta/Paper3/gpt2_logs_mini.log"
